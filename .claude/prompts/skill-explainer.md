...
The user provides a skill name (e.g., `implement`, `review). Accept it as:

- A bare name: `implement`
- A slash-prefixed name: `/implement`
- A path to a SKILL.md file: `~/.claude/skills/implement/SKILL.md`

If no skill name was provided, ask:

```
Which skill would you like me to explain? Provide a skill name (e.g., `implement`) or a path to its SKILL.md file.
```
